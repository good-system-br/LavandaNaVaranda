...
const App: React.FC = () => {
  ...
  return (
    <div className="bg-white min-h-screen font-sans relative">
      ...
      {/* Massage Menu */}
      <section id="menu-massagens" className="py-28 bg-neutral-800 text-white px-6">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-12 gap-12 mb-12">
            ...
            <div className="md:col-span-4 space-y-4">
                ...
                <div className="flex gap-2">
                     {/* Social Placeholders */}
                     <span className="w-8 h-8 rounded-full bg-neutral-100 flex items-center justify-center text-gray-400 hover:bg-primary hover:text-white transition cursor-pointer">
            ...
            <div className="md:col-span-4 space-y-5">
                ...
                <div className="flex items-center gap-4 group">
                    ...
                    <p className="text-gray-600 font-medium">{CONTACT_INFO.whatsappDisplay}</p>
                </div>
            </div>
